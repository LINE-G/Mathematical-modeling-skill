...
2. Select applicable checks:
   ...
   - analytical limiting-case, conservation, feasibility, or dimensional check;
   - independent simulation or held-out scenario check;
   - module ablation for a multi-stage architecture;
   - adversarial or boundary scenario aligned to constraints.
...
- check role: calibration, validation, robustness, ablation, or boundary test.
...
- For multi-stage models, each load-bearing layer has evidence or an explicit limitation.
